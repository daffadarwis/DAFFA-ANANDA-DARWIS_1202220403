...
public class RobotApp {
    ...
    private void executeInstruction(String instruction) {
        if (instruction.length() < 2) {
            System.out.println("Input tidak benar. Masukkan langkah-langkahnya dengan benar!");
            return;
        }
        ...
        try {
            ...
            System.out.println("Input tidak benar. Masukkan nomor step dengan benar!");
            return;
        }
        ...
        if(isValidPosition(newPosition)) {
            ...
            System.out.println("Input terlalu besar, Arena tidak mencukupi!");
        }
    }
